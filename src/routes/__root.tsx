...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Why This Word" },
      { name: "description", content: "A contrastive-semantics reader for the Greek New Testament. Explore why biblical authors chose this word, not a nearby alternative." },
