      ...
      <main className="mx-auto max-w-2xl px-6 py-16">
        ...
        <div className="mt-8 space-y-6 font-serif text-[17px] leading-relaxed text-reader-ink">
          <p>
            ...
            <em>
              {" "}
              why might the biblical author have chosen this word instead of a nearby
              alternative?
            </em>
          </p>
          <p>
            The interface is intentionally quiet. Pick a verse, click a Greek word, and a
            side panel opens with the lexical entry, a curated set of semantic neighbours,
            and a short reflection on what nuance would shift if one neighbour stood in
            for the chosen word.
          </p>
          ...
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>
              Not a standard lexicon; entries are kept short and read for contrast rather
              than completeness.
            </li>
            <li>
              Not a devotional or a dogmatic engine. The tone is that of a careful
              seminary tutor: hedged, comparative, never certain about the author's mind.
            </li>
          </ul>
          <h2 className="pt-4 font-serif text-2xl text-foreground">Prototype scope</h2>
          <p>
            This is an MVP. The Greek text and contrastive notes are a curated mock
            dataset covering a handful of passages (John 1:1, John 21:15–17, Romans
            3:21–26, Ephesians 2:8–9, Matthew 5:3). The data layer is modular: real
            sources such as SBLGNT, MorphGNT, Strong's, and AI-generated explanations
            can later be plugged in behind the same component surface.
          </p>
          <div className="pt-4">
            <Link
              to="/reader/john-1"
