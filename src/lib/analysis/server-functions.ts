...
export const getSemanticAnalysisServer = createServerFn({ method: "GET" })
  ...
  .handler(async ({ data }) => {
    console.log(
      `\x1b[36m[Analysis]\x1b[0m Starting request for: \x1b[35m${data.lemma}\x1b[0m at \x1b[35m${data.ref}\x1b[0m (\x1b[35m${data.language || "greek"}\x1b[0m)`,
    );
    ...
    console.log(
      `\x1b[36m[Analysis]\x1b[0m \x1b[33mCache MISS\x1b[0m for: ${data.lemma}. Querying Gemini...`,
    );
